    ...
    <section className='portfolio'>
      <article className='portfolio__container'>
        ...
        <nav className='portfolio__links'>
          <a target='_blank' href='https://github.com/VanyaDanyaGachist/how-to-learn' className='portfolio__link'>
          ...
          <a target='_blank' href='https://vanyagachist2.github.io/project__russia/' className='portfolio__link'>
          ...
          <div className='portfolio__line'></div>
          <a target='_blank' href='https://github.com/VanyaGachist2/react-mesto-auth' className='portfolio__link'>
